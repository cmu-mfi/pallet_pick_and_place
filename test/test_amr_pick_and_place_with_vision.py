...
def run():
    ...
    T_tray_world = RigidTransform.load('amr_tray.tf')
    ...
    while np.abs(amr_angle) > 10:
        ...
        tray_amr_offset = RigidTransform.load('tray_amr.tf')#(translation=np.array([0.147, 0.14, 0.05]), from_frame='tray', to_frame='amr')
