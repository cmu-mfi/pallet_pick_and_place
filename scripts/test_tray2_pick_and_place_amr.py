...
def run():
    ...
    rospy.init_node("test_tray2_pick_and_place_amr")

    namespace = rospy.get_param("test_tray2_pick_and_place_amr/namespace")
    root_pwd = rospy.get_param("test_tray2_pick_and_place_amr/root_pwd")
    ...
    T_hook_world_target_70.translation = T_tray_world.translation + np.array([-0.02,0,0])

    T_ee_world_target = T_hook_world_target_70 * T_hook_ee.inverse()

    goal_pose = T_ee_world_target.pose_msg

    print("Move Left 2cm to jiggle the tray into the slot.")
